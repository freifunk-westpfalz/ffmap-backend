...
/usr/bin/python3 $WORKDIR/backend.py --with-rrd --prune 45 -m mzBAT:/var/run/alfred-mz.sock --vpn 02:00:0a:25:00:17 02:00:0a:25:00:05 02:00:0a:25:00:07 02:00:0a:25:00:d0 02:00:0a:25:00:e7 02:00:0a:25:00:2a -d $WORKDIR/data/
