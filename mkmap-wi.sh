...
WORKDIR="/home/admin/clones/ffmap-backend-intern-wi"
WWWDIRINTERN="/var/www/meshviewer-intern-wi"
WWWDIREXTERN="/var/www/meshviewer-extern-wi"

cd "$(dirname "$0")"/

/usr/bin/python3 $WORKDIR/backend.py --with-rrd --prune 45 -m wiBAT:/var/run/alfred-wi.sock --vpn 02:00:0a:38:00:17 02:00:0a:38:00:05 02:00:0a:38:00:07 02:00:0a:38:00:d0 02:00:0a:38:00:e7 02:00:0a:38:00:2a -d $WORKDIR/data/
